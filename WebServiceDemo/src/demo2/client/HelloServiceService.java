 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://ws.demo2/", wsdlLocation = "http://127.0.0.1:6789/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://ws.demo2/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:6789/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://ws.demo2/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.demo2/", "HelloServicePort"), HelloService.class, features);
    }
