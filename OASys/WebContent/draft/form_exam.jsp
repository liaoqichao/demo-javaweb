...
<script type="text/javascript" src="js/form_examine.js"></script>
  			...
  			<div class="panel-body">
    			<div class="btn-group btn-group-justified" role="group" aria-label="...">
					<div class="btn-group" role="group">
    					...
    					<button type="button" class="btn btn-default"  style="width:150px;" onclick="add_staff();">添加</button>
    					<button type="button" class="btn btn-default" style="width:150px;" onclick="return_staff()">返回</button>
  					</div>
				</div>
  			</div>
		</div>
