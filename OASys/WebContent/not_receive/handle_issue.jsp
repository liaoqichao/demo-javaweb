...
<script type="text/javascript" src="js/handle_issue.js"></script>
...
<div class="panel panel-primary" style="float:left;width:70%;min-width:550px;min-height:300px;max-height:700px;margin-left:50px">
  ...
  <div class="panel-heading">签发</div>
			...
			<!-- List group -->
  			<ul class="list-group">
  				<li class="list-group-item list-group-item-success">
  					<input type="checkbox" id=passCheckbox  onclick="passcheckbox();"  value="1" style="font-size:16px;margin-left:50px;">通过
  					<input type="checkbox" id=failCheckbox onclick="failcheckbox();" value="1" style="font-size:16px;margin-left:50px;">退回
  				</li>
  				<li class="list-group-item list-group-item-default"><textarea id=remarks  name=remarks cols="100" rows="6"></textarea> </li>
  			</ul>
  			<div class="btn-group btn-group-justified" role="group" aria-label="..." style="margin-top:12px;margin-bottom:12px;margin-left:50px;">
					<div class="btn-group" role="group">
    					...
    					<button type="button" class="btn btn-default"  style="width:150px;" onclick="submit_issue();">提交</button>
...
<script>
function passcheckbox(){
	if(document.getElementById("passCheckbox").checked==true){
		document.getElementById("failCheckbox").checked=false;
	}
}
function failcheckbox(){
	if(document.getElementById("failCheckbox").checked==true){
		document.getElementById("passCheckbox").checked=false;
	}
}
function return_unreceive(){
	window.location.href="search_not_receive.jsp";
}
</script>
</body>
</html>